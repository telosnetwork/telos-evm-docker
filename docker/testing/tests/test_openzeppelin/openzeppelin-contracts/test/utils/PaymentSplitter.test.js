...
contract('PaymentSplitter', function (accounts) {
  ...
  context('once deployed', function () {
    ...
    it('distributes funds to payees', async function () {
      ...
      const { logs: logs1 } = await this.contract.release(payee1, { gasPrice: 5000000000000 });
      ...
      const { logs: logs2 } = await this.contract.release(payee2, { gasPrice: 5000000000000 });
      ...
      const { logs: logs3 } = await this.contract.release(payee3, { gasPrice: 5000000000000 });
