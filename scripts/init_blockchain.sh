...
for i in eosio.token eosio.rex eosio.ram eosio.ramfee eosio.stake eosio.bpay eosio.vpay eosio.names eosio.saving eosio.trail thisisatesta thisisatestb; do
